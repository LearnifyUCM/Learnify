...
function Home() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.error('SUBMIT_HOME: Network Error in Fetch:', e.message);
            setApiError(`Network Error: Could not connect to backend at ${BACKEND_URL}.`);
        } finally {
                            ...
                            <div className="bg-gray-800/30 rounded-xl border border-gray-700/50 p-8">
                                ...
                                <div className="flex gap-4 mt-8">
                                    <button
                                        onClick={handleBack}
                                        disabled={isProcessing}
                                        className="flex-1 px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors disabled:bg-gray-500"
                                    >
                                        Back
                                    </button>
                                    <button
                                    ...
                                    >
                                        {isProcessing ? 'Generating...' : `Generate Study Session (${selectedFiles.length})`}
                                    </button>
                                </div>
